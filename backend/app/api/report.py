...
def get_generate_status():
    ...
    try:
        ...
        logger.error(f"Échec de la vérification du statut de la tâche : {str(e)}")
        return jsonify({
            "success": False,
            "error": str(e)
        }), 500
...
def get_agent_log(report_id: str):
    ...
    try:
        ...
        logger.error(f"Échec de la récupération du journal de l'agent : {str(e)}")
        return jsonify({
            "success": False,
            "error": str(e),
            "traceback": traceback.format_exc()
...
def get_console_log(report_id: str):
    ...
    try:
        ...
        logger.error(f"Échec de la récupération du journal de la console : {str(e)}")
        return jsonify({
            "success": False,
            "error": str(e),
            "traceback": traceback.format_exc()
