...
def create_app(config_class=Config):
    ...
    if should_log_startup:
        logger.info("=" * 50)
        logger.info("Démarrage de MiroFish Backend...")
        logger.info("=" * 50)
    ...
    # MiroPolis (CLAUDE.md §6) : agent de scénario tendanciel, même chemin que le contrat d'API
    # partagé avec GEMINI.md -- toute modification de préfixe doit être répercutée dans les deux fichiers.
    ...
    if should_log_startup:
        logger.info("Démarrage de MiroFish Backend terminé")
